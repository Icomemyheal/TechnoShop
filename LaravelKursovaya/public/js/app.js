...
//Mobile Menu
var burgerBtn = document.querySelector('.js-header__btn--menu');
var headerNavMenu = document.querySelector('.js-header__menu');
...
document.addEventListener('DOMContentLoaded', function () {
  var basketCheckoutBtn = document.querySelector('.js-checkout-btn');
  var basketCheckoutModal = document.querySelector('.js-checkout-modal');
  var basketModalOverlay = document.querySelector('.js-overlay');
  var basketModalCloseBtn = document.querySelector('.js-close-checkout');
  var checkoutProductList = document.querySelector('.js-checkout-list');
  basketCheckoutBtn === null || basketCheckoutBtn === void 0 || basketCheckoutBtn.addEventListener('click', function () {
  ...
  basketModalOverlay.addEventListener('click', function (e) {
  ...
  basketModalCloseBtn.addEventListener('click', function () {
    basketCheckoutModal.classList.remove('active');
    basketModalOverlay.classList.remove('overlay');
    burgerBtn.removeAttribute("disabled", "");
  });
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var filterBtn = filterBtns.forEach(function (btn) {
    console.log(btn);
...
document.addEventListener('DOMContentLoaded', function () {
  var basketProductList = document.querySelector('.js-basket-list');
  var orderProductList = document.querySelector('.js-order-list');
  var checkoutProductList = document.querySelector('.js-checkout-list');
  var checkoutBtn = document.querySelector('.js-checkout-btn');
  if (basketProductList.childElementCount === 0 && orderProductList.childElementCount === 0 && checkoutProductList.childElementCount === 0) {
    var basketListChild = document.createElement('p');
    var orderListChild = document.createElement('p');
...
function validateForm() {
  ...
  var firstNameError = document.querySelector('.input__firstName--error');
  var lastNameError = document.querySelector('.input__lastName--error');
  var phoneNumberError = document.querySelector('.input__phoneNumber--error');
  var emailError = document.querySelector('.input__email--error');
...
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".hero__swiper", {
...
/******/ __webpack_require__.O(0, ["css/style","/js/vendor"], () => (__webpack_exec__("./resources/js/app.js"), __webpack_exec__("./public/css/style.scss")));
